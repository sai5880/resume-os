...
function Features() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative mx-auto max-w-6xl px-6 pt-16 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-xl text-[15px] leading-relaxed text-ink-soft", children: "Discover how ResumeOS combines cutting-edge AI technology with practical tools to help you create resumes that get results." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-6xl px-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: [{
      ...
      title: "Section-by-section AI",
      description: "Rewrite Summary, Experience, or Projects with one-click goals like 'FAANG-ready' or 'Quantified impact'. Live diffs before you commit.",
      details: "Our AI understands context and industry standards, providing tailored suggestions that improve your resume's impact."
    }, {
      ...
      title: "ATS that actually parses",
      description: "Export with @react-pdf/renderer — true text layers, no canvas tricks. Scores tuned to recruiter ATS heuristics.",
      details: "Get real-time ATS scoring and optimization suggestions to ensure your resume passes automated screening systems."
    }, {
      ...
      description: "WebGPU inference in a Web Worker. Model cached after first load. Nothing uploaded, ever.",
      details: "Your data stays on your device. No cloud processing, no data collection, complete privacy and security."
    }, {
      ...
      description: "Professionally designed templates that adapt to your content and industry requirements.",
      details: "Choose from multiple templates optimized for different roles and experience levels."
    }, {
      ...
      title: "PDF export",
      description: "Generate high-quality, text-selectable PDFs that look great on any device.",
      details: "True text-layer PDFs ensure compatibility with ATS systems and maintain formatting across platforms."
    }, {
      ...
      description: "See changes instantly with live preview and collaborative editing capabilities.",
      details: "Edit your resume with immediate visual feedback and AI-powered suggestions as you type."
    }].map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0,
      y: 24
    }, animate: {
      opacity: 1,
      ...
      delay: index * 0.1,
      duration: 0.6
    }, className: "rounded-xl border border-rule bg-card p-6 hover:border-ai/30 transition-colors", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-ink mb-3", children: feature.icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-display text-lg mb-2", children: feature.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-ink-soft leading-relaxed mb-3", children: feature.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-ink-soft/70 leading-relaxed", children: feature.details })
    ] }, feature.title)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-6xl px-6 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-rule bg-card p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-mono-display text-2xl mb-4", children: "Ready to get started?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-ink-soft mb-6 max-w-md mx-auto", children: "Join thousands of professionals who have improved their resumes with ResumeOS." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/editor", className: "rounded-md bg-ink text-paper px-6 py-3 text-[13px] font-mono hover:opacity-90 transition inline-block", children: "Start building your resume →" })
    ] }) }),
