...
const appCss = "./assets/styles-m5PPynol.css";
...
const $$splitComponentImporter$3 = () => import("./privacy-CYnilJYy.js");
const Route$3 = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
      title: "Privacy — ResumeOS"
    }, {
      name: "description",
      content: "Learn about ResumeOS's privacy-first approach. Your resume data never leaves your device."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./features-CuDYXF7Q.js");
const Route$2 = createFileRoute("/features")({
  head: () => ({
    meta: [{
      title: "Features — ResumeOS"
    }, {
      name: "description",
      content: "Explore the powerful features of ResumeOS: AI-powered resume writing, ATS optimization, and local-first design."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./editor-DrDlxsc6.js").then((n) => n.e);
const Route$1 = createFileRoute("/editor")({
  head: () => ({
    meta: [{
      title: "ResumeOS — Editor"
    }, {
      name: "description",
      content: "Local-first AI resume editor with dynamic sections and intelligent import."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BNmLgOLy.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "ResumeOS — Your AI Career Operating System"
    }, {
      name: "description",
      content: "Local-first AI resume builder. WebGPU inference, ATS-optimized text-layer PDFs. Your resume never leaves your device."
    }, {
      property: "og:title",
      content: "ResumeOS — Your AI Career Operating System"
    }, {
      property: "og:description",
      content: "Private. Local. ATS-optimized."
    }]
  }),
